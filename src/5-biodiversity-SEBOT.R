...
vegan::scores(nmds, "sites") %>%
  ...
  mutate(habitat = fct_recode(habitat, "BOSQUES" = "forest", "PRADOS" = "meadow",
                              "PARQUES" = "park", "CUNETAS" = "roadside",
                              "RESIDENCIALES" = "residential", "INDUSTRIALES" = "industrial")) -> sitescores
...
#        axis.title = element_blank(),
  ...
  scale_x_continuous(name = "Dimensión 1", labels = scales::number_format(accuracy = 0.1),
                     breaks = seq(-2, 2, by = 0.5)) + 
  scale_y_continuous(name = "Dimensión 2", labels = scales::number_format(accuracy = 0.1),
                     breaks = seq(-2, 2, by = 0.5)) +
...
ggsave(F3DEFL, file = "results/figures/Fig3-SEBOT.png", bg = "white", 
       path = NULL, scale = 1, width = 300, height = 140, units = "mm", dpi = 600)
