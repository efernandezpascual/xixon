...
ggsave(FS1a, file = "results/supplementary/FigS1a.png", bg = "white", 
...
ggsave(FS1b, file = "results/supplementary/FigS1b.png", bg = "white", 
       path = NULL, scale = 1, width = 180, height = 180, units = "mm", dpi = 600)
...
ggsave(FS1c, file = "results/supplementary/FigS1c.png", bg = "white", 
       path = NULL, scale = 1, width = 180, height = 180, units = "mm", dpi = 600)
...
datos %>%
  ...
  mutate(Trait = fct_recode(Trait, "Soil Pb" = "Pb",
